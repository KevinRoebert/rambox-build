...
const initialize = (window) => {
	...
	autoUpdater.on('update-downloaded', (version, files, path, sha512, releaseName, releaseNotes, releaseDate, stagingPercentage) => send('autoUpdater:update-downloaded', version, files, path, sha512, releaseName, releaseNotes, releaseDate, stagingPercentage));
